...
def register():
    ...
    if form.validate_on_submit():
        ...
        if BlogUser.query.filter_by(email=form.email.data).first():
            error = "You have already signed up with this email, login instead."
...
def show_post(post_id):
    ...
    if form.validate_on_submit():
        if current_user.is_authenticated:
            ...
            error = "You haven't logged in, please login first. "
            return redirect(url_for("login", error=error))
